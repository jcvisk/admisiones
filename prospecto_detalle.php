    ...
    <div class='row'>
      ...
      <main role='main' class='col-md-9 ml-sm-auto col-lg-10 px-md-4'>
        <div
          ...
          <?= isset($_SESSION['change_status_successful']) ? $_SESSION['change_status_successful'] : '' ?>
          <div class='btn-toolbar mb-2 mb-md-0'>
            <div class='btn-group mr-2'>
              <a href="convert_to_student.php?id=<?= $_GET['id'] ?>" role="button" type='button' class='btn btn-sm btn-outline-secondary'>Admitir</a>
